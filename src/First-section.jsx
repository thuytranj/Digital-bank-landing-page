export default function FirstSection() {
  return (
    <div className="bg-[var(--color-gray-50)] relative w-full h-170 flex items-center max-lg:flex-col overflow-hidden max-lg:pb-5 max-lg:h-auto">
      <img src="/images/bg-intro-mobile.svg" alt="bg-intro" className="w-full h-auto object-cover lg:hidden" />
      ...
      <img src='/images/bg-intro-desktop.svg' className="z-0 absolute top-[-100px] right-[-120px] h-full w-auto object-contain animate-zoom-in max-lg:hidden"></img>
      
      <img src="/images/image-mockups.png" className="z-1 w-1/2 h-auto object-cover absolute top-[-200px] right-[-150px] animate-zoom-in max-lg:right-0 max-lg:top-[-100px] max-lg:w-full"></img>
